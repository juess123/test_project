...
//2023-12-5 18：42 添加的关于比设机械臂的宏定义
#define openmv_center_x_coordinate 160 //     320/2
#define openmv_center_y_coordinate 120 //     240/2
#define NULL (0)
#define init_servo_1_angle 30
#define init_servo_2_angle 170
#define init_servo_3_angle 185
#define init_servo_4_angle 80
#define const_target_pixel (uint16_t)15000